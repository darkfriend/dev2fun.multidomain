<template>
    <table class="adm-detail-content-table edit-table" id="donate_edit_table">
        <tbody>
        <tr>
                        ...
                        <div class="o-grid__cell o-grid__cell--width-70">
                            <div class="c-card">
                                <div class="c-card__body">
                                    <p class="c-paragraph" v-html="locale.LABEL_TITLE_HELP_BEGIN">.</p>
                                    <div v-html="locale.LABEL_TITLE_HELP_BEGIN_TEXT"></div>
                                </div>
                            </div>
                            <div class="o-container--large">
                                ...
                                <table class="c-table">
                                    ...
                                    <tr class="c-table__row">
                                        ...
                                        <td class="c-table__cell"><a
                                            href="https://www.paypal.me/darkfriend" target="_blank">paypal.me/@darkfriend</a>
                                        </td>
                                    </tr>
                                    <tr class="c-table__row">
                                    ...
                                    <tr class="c-table__row">
                                        ...
                                        <td class="c-table__cell">
                                            15Veahdvoqg3AFx3FvvKL4KEfZb6xZiM6n
                                        </td>
                                    </tr>
                                    <tr class="c-table__row">
                                        <td class="c-table__cell">Litecoin</td>
                                        <td class="c-table__cell">
                                            LRN5cssgwrGWMnQruumfV2V7wySoRu7A5t
                                        </td>
                                    </tr>
                                    <tr class="c-table__row">
                                        <td class="c-table__cell">Ethereum</td>
                                        <td class="c-table__cell">
                                            0xe287Ac7150a087e582ab223532928a89c7A7E7B2
                                        </td>
                                    </tr>
                                    <tr class="c-table__row">
                                ...
                                <h2 id="moreThanks" class="c-heading u-large" v-html="locale.LABEL_TITLE_HELP_DONATE_OTHER_TEXT"></h2>
                                <div v-html="locale.LABEL_TITLE_HELP_DONATE_OTHER_TEXT_S"></div>
                            </div>
                        </div>
                        <div class="o-grid__cell o-grid__cell--width-30">
                            <h2 id="moreThanks" class="c-heading u-large" v-html="locale.LABEL_TITLE_HELP_DONATE_FOLLOW"></h2>
                            <table class="c-table">
